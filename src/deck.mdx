...
A framework or library can only be as solid as its foundation, a.k.a. dependencies.
...
HTML, CSS, and JavaScript -- all 3 main building blocks of web apps can now be validated.
